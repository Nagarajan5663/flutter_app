...
class InventoryValuationSummaryPage extends StatelessWidget {
  final VoidCallback onBack;

  const InventoryValuationSummaryPage({
    super.key,
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: const Row(
                              children: [
                                ...
                                Expanded(
                                  flex: 2,
                                  child: ReportTableHeaderText('STOCK QUANTITY'),
                                ),
                                Expanded(
                                  flex: 2,
                                  child: ReportTableHeaderText('PURCHASE PRICE'),
                                ),
                                Expanded(
                                  flex: 2,
                          ...
                          const ReportEmptyRow(
                            message:
                                'No inventory items found or purchase prices not set.',
                          ),
                        ],
                      ),
                    ),
