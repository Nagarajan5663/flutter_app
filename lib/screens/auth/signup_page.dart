...
class _SignUpPageState extends State<SignUpPage> {
  ...
  bool _validate() {
    setState(() {
      _orgNameError = _orgNameController.text.trim().isEmpty
          ? 'Enter your organization name'
          : null;

      _orgEmailError = _orgEmailController.text.trim().isEmpty
          ? 'Enter your organization email'
          : (!_orgEmailController.text.contains('@')
  ...
  Future<void> _handleCreateAccount() async {
    ...
    // TODO: Replace this with your real sign-up call
    ...
    _showMessage('Account created for ${_orgNameController.text.trim()}');
  }
