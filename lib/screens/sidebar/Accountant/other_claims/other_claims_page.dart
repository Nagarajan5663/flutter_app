...
class OtherClaimsPage extends StatefulWidget {
  const OtherClaimsPage({
    super.key,
  });

  @override
  State<OtherClaimsPage> createState() => _OtherClaimsPageState();
}

class _OtherClaimsPageState extends State<OtherClaimsPage> {
  final List<OtherClaimData> _claims = [];

  int _claimCounter = 1;

  void _openNewClaimForm() {
    showDialog(
      context: context,
      barrierDismissible: false,
      barrierColor: const Color(0x9A12202C),
      builder: (context) {
        return NewOtherClaimDialog(
          nextNumber: 'CLAIM-$_claimCounter',
          onSave: (claim) {
            setState(() {
              _claims.add(claim);
              _claimCounter++;
  ...
  void _deleteClaim(OtherClaimData claim) {
    setState(() {
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'INR ${claim.total.toStringAsFixed(2)}',
                          style: const TextStyle(
                            color: Color(0xFF17395C),
...
class _StatusBadge extends StatelessWidget {
  ...
  Color get _backgroundColor {
    switch (status) {
      case OtherClaimStatus.pending:
        return const Color(0xFFFFF3E0);
      case OtherClaimStatus.approved:
        return const Color(0xFFE3F2FD);
      case OtherClaimStatus.paid:
        return const Color(0xFFE6F7EC);
      case OtherClaimStatus.rejected:
...
// ===================================================================
// OTHER CLAIM DATA MODEL
// ===================================================================

class OtherClaimData {
  final DateTime date;
  ...
  OtherClaimData({
    ...
    this.status = OtherClaimStatus.pending,
  });
}

// ===================================================================
// NEW OTHER CLAIM DIALOG
// ===================================================================

class NewOtherClaimDialog extends StatefulWidget {
  final String nextNumber;
  final ValueChanged<OtherClaimData> onSave;

  const NewOtherClaimDialog({
    super.key,
  ...
  @override
  State<NewOtherClaimDialog> createState() =>
      _NewOtherClaimDialogState();
}

class _NewOtherClaimDialogState extends State<NewOtherClaimDialog> {
  // ================================================================
  // FORM KEY
  // ================================================================
  ...
  late final TextEditingController claimNumberController =
  ...
  final List<String> claimCategories = [
    'Medical Claim',
    'Insurance Claim',
    'Damage / Loss Claim',
    'Warranty Claim',
  ...
  void _saveClaim() {
    ...
    if (selectedPaymentAccount == null) {
      _showMessage('Please select a payment account.');
      return;
    }

    if (payeeController.text.trim().isEmpty) {
      _showMessage('Please select or enter a payee.');
      return;
    }
    ...
    widget.onSave(
      OtherClaimData(
        date: selectedDate,
        claimNumber: claimNumberController.text.trim(),
                ...
                child: Form(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        // =================================================
                        // ROW 1: DATE / EXPENSE CATEGORY / PAYMENT ACCOUNT
                        // =================================================
                          ...
                          children: [
                            Expanded(
                              child: _buildTextField(
                                label: 'Claim # *',
                                controller: claimNumberController,
                              ),
                            ),
